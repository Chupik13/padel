const changelog = [
  {
    version: '1.1.2',
    date: '2026-03-03',
    description: 'Исправления статистики и фильтрации турниров.',
    sections: [
      {
        title: 'Исправлено',
        items: [
          'Отменённые турниры больше не учитываются в статистике профиля и сезонном рейтинге.',
          'Битые турниры без команд/игроков скрыты из всех списков.',
        ],
      },
    ],
  },
  {
    version: '1.1.1',
    date: '2026-03-03',
    description: 'Теги статусов и мелкие UI-фиксы.',
    sections: [
      {
        title: 'Добавлено',
        items: [
          'Тег «Досрочно» для досрочно завершённых турниров.',
          'Тег количества матчей в истории.',
        ],
      },
      {
        title: 'Исправлено',
